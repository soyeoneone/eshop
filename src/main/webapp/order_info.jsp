...
<div class="container">
            ...
            <table class="table table-bordered">
                ...
                <c:forEach items="${sessionScope.cartMap}" var="cart">
                    <tr class="active">
                        ...
                        <td width="10%">${cart.value.quantity}</td>
                        <td width="15%"><span class="subtotal">￥${cart.value.shop_price*cart.value.quantity}</span></td>
                    </tr>
                </c:forEach>
                </tbody>
            </table>
    ...
    <form class="form-horizontal" action="/order" method="post" id="orderForm"
        ...
        <input type="hidden" name="orderId" value="${requestScope.order.oid}">
        <div>
            <hr/>
