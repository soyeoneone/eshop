				...
				<div style="margin:0 auto; margin-top:10px;width:950px;">
					...
					<table class="table table-bordered">
						<tbody>
							...
							<c:forEach items="${sessionScope.cartMap}" var="cart">
								<tr class="active">
								...
								<td width="10%">
									<input type="text" name="quantity" value="${cart.value.quantity}" maxlength="4" size="10">
								</td>
								<td width="15%">
									<span class="subtotal">￥${cart.value.shop_price*cart.value.quantity}</span>
								</td>
								<td>
									<a href="/cart?method=deleteById&pid=${cart.key}" class="delete">删除</a>
								</td>
								</tr>
							</c:forEach>
						</tbody>
